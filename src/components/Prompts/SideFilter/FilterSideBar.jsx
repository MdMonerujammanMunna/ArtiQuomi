...
export default function FilterSidebar() {
    ...
    const categories = ["All", "Coding", "Copywriting", "Design", "Marketing"];
    ...
    return (
        <aside className="w-full max-w-[180px] bg-[#0b1220] border border-slate-800 rounded-2xl p-5 flex flex-col gap-6 text-gray-400 select-none">
